...
Sensitivity analysis methods, such as Sobol indices and variance-based decomposition, provide a quantitative measure of how much each parameter affects system outputs (Valentin, 2022, June 20). Consequently, engineers can focus on the most important parameters in their calibration efforts, reducing development time and improving productivity.
...
## References
  ...
  - Lubos Pirkl, (2024, January 9). AI for CAE. https://www.linkedin.com/pulse/ai-cfd-lubos-pirkl-jiame/
  - Valentin, C, (2022, June 20), Sobol Indices to Measure Feature Importance. https://towardsdatascience.com/sobol-indices-to-measure-feature-importance-54cedc3281bc/
