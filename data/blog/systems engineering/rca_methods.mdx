...
draft: false
summary: 'Have you seen teams start on the wrong path to finding a root cause of a problem and spend weeks with no problem statement. Read on if you would like a flowchart to choose the right method to find a root cause.'
authors: ['Kausi']
images:
  [
    '/static/images/systemthinking.png',
    '/static/images/RCA_title.png',
    '/static/images/rcachart.png',
  ]
---
![RCA](/static/images/RCA_title.png)

<Image alt="RCA" src="/static/images/RCA_title.png" width={256} height={128} />

# Systems Thinking in Action
If you are a Systems Engineer involved in definition, design, implementation, integration, or validation, you have most likely encountered the term "systems thinking" many times. But what does it truly mean?
...
Here is a summary of commonly used RCA methods and guidance on when to use each. If you’d like to get to the summary and a flowchart, feel free to scroll to the end of the post.
### 5 Why
...
![RCA](/static/images/rcachart.png)
