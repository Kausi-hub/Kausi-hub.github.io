...
draft: false
summary: 'Have you seen teams start on a wrong path to finding a root cause to a problem and spend weeks with no problem statement. Read on if you would like a flowchart to choose the right method to finding a rootcause'
authors: ['Kausi']
images:
  [
    '/static/images/p-diag.png',
    '/static/images/elementsofP.png',
    '/static/images/ElementsofDisco.png',
    '/static/images/pdiagdisco.png',
  ]
---

![P-Diagram](/static/images/p-diag.png)
...
![Elements of P](/static/images/elementsofP.png)
...
![Elements of disco](/static/images/ElementsofDisco.png)
...
![P Error](/static/images/sourcesoferror.png)
