...
https://colab.research.google.com/drive/1iOfh-r7P72AkS-M10VQFWOO2Wdy2cxmg#scrollTo=QiFynKQdY9T_&line=9&uniqifier=1
...
required_columns = ['Thermal_Cycles', 'Max_Temperature', 'Delta_Temperature', 'Rds_on', 'Threshold_Voltage_Drift', 'Wear_Condition'] # Ensure relevant columns exist
