...
draft: false
summary: 'What are P-diagrams and why are they an essential tool that system engineers must consider during product design? If you are curious to learn more with a practical example of an automotive subsystem, continue to read on.'
authors: ['Kausi']
...
![P disco](/static/images/pdiagdisco.png)
